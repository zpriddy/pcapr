...
(function($) {
    function Plot(target_, data_, options_) {
        ...
        function constructCanvas() {
            canvasWidth = parseInt(target.width());
            canvasHeight = parseInt(target.height());
            ...
            // bind events
            if (options.selection.mode || options.grid.hoverable) {
        ...
        function setRange(axis, axisOptions) {
            var min = axisOptions.min ? axisOptions.min : axis.datamin;
            var max = axisOptions.max ? axisOptions.max : axis.datamax;
        ...
        function prepareTickGeneration(axis, axisOptions) {
            ...
            if (axisOptions.labelWidth) {
				axis.labelWidth = axisOptions.labelWidth;
			}
            if (axisOptions.labelHeight) {
        ...
        function setTicks(axis, axisOptions) {
            ...
            if (!axisOptions.ticks) {
				...
				if (typeof axisOptions.ticks == "number") {
        ...
        function setSpacing() {
            ...
            function measureYLabels(axis) {
                if (!axis.labelWidth || !axis.labelHeight) {
                    var i, labels = [], l;
